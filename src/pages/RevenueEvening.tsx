...
import { Plus, Trash2, Loader2, Save, X, Moon } from 'lucide-react';
...
const RevenueEvening = () => {
    ...
    // Autocomplete
    const { filterSubcategories } = useRevenueSubcategories('evening');
        ...
        <div>
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold text-slate-800">Ventes Soir (Crêpes & Shawarma)</h1>
                </div>
                <button
                    onClick={startAdding}
